...
- The 'Lite' column indicates which metrics are generated by bamQC lite, starred metrics use 
      downsampled data. Also, 'mismatch by cycle' in Lite version combines the metric for all reads
      Samblaster replaces picard in Lite version for calculation of DuplicateReads metric

| Name                            | Former name          | Source                  | DS | WFM | Lite|
| --------------------------------|----------------------|-------------------------|----|-----|-----|
| alignment reference             |                      | input parameter         | N  |  Y  |  Y  |
| average read length             |                      | samtools stats: RL      | N  |  Y  |  Y  |
| bases per target                |                      | bedtools                | Y  |  N  |  Y  |
| barcode                         |                      | metadata                | N  |  N  |  Y  |
| bases mapped                    | aligned bases        | samtools stats: SN      | N  |  Y  |  Y  |
| coverage per target             |                      | bedtools                | Y  |  N  |  Y  |
| coverage histogram              |                      | bedtools                | Y  |  N  |  Y  |
| deleted bases                   |                      | samtools stats: ID      | N  |  Y  |  Y  |
| donor                           |                      | metadata                | N  |  N  |  Y  |
| group id                        |                      | metadata                | N  |  N  |  Y  |
| hard clip bases                 |                      | CIGAR                   | Y  |  N  |  Y  |
| insert max                      |                      | input parameter         | N  |  Y  |  Y  |
| insert size average             | insert mean          | samtools stats: SN      | N  |  Y  |  Y  |
| insert size histogram           | insert histogram     | samtools stats: IS      | N  |  Y  |  Y  |
| insert size standard deviation  | insert stdev         | samtools stats: SN      | N  |  Y  |  Y  |
| inserted bases                  |                      | samtools stats: ID      | N  |  Y  |  Y  |
| instrument                      |                      | metadata                | N  |  N  |  Y  |
| lane                            |                      | metadata                | N  |  N  |  Y  |
| library                         |                      | metadata                | N  |  N  |  Y  |
| library design                  |                      | metadata                | N  |  N  |  Y  |
| low-quality reads meta          |                      | metadata                | N  |  N  |  N  |
| mapped reads                    |                      | samtools stats: SN      | N  |  Y  |  Y  |
| mark duplicates                 |                      | Picard MarkDuplicates   | N  |  N  |  Y* |
| mean genomic(target) coverage   |                      | calculated              | N  |  N  |  Y  |
| mismatched bases                | mismatch bases       | samtools stats: SN      | N  |  Y  |  Y  |
| non primary reads               |                      | samtools stats: SN      | N  |  Y  |  Y  |
| non-primary reads meta          |                      | metadata                | N  |  N  |  N  |
| number of targets               |                      | bedtools                | N  |  N  |  Y  |
| package version                 |                      | package version file    | N  |  Y  |  Y  |
| paired end                      | number of ends       | samtools stats: SN      | N  |  Y  |  Y  |
| paired reads                    |                      | samtools stats: SN      | N  |  Y  |  Y  |
| pairsMappedAbnormallyFar        |                      | insert size histogram   | Y  |  Y  |  Y  |
| pairsMappedToDifferentChr       |                      | samtools stats: SN      | N  |  Y  |  Y  |
| properly paired reads           |                      | samtools stats: SN      | N  |  Y  |  Y  |
| qual cut                        |                      | input parameter         | N  |  N  |  N  |
| qual fail reads                 |                      | samtools view           | N  |  N  |  Y  |
| read 1 aligned by cycle         |                      | CIGAR                   | Y  |  N  |  Y  |
| read 1 average length           |                      | samtools stats: FRL     | N  |  Y  |  Y  |
| read 1 deletion by cycle        |                      | CIGAR                   | Y  |  N  |  Y  |
| read 1 hard clip by cycle       |                      | CIGAR                   | Y  |  N  |  Y  |
| read 1 insertion by cycle       |                      | CIGAR                   | Y  |  N  |  Y  |
| read 1 length histogram         |                      | samtools stats: FRL     | N  |  Y  |  Y  |
| read 1 mismatch by cycle        |                      | samtools stats: MPC     | N  |  Y  |  -  |
| read 1 quality by cycle         |                      | samtools stats: FFQ     | N  |  Y  |  Y  |
| read 1 quality histogram        |                      | samtools stats: FFQ     | N  |  Y  |  Y  |
| read 1 soft clip by cycle       |                      | CIGAR                   | Y  |  N  |  Y  |
| read 2 aligned by cycle         |                      | CIGAR                   | Y  |  N  |  Y  |
| read 2 average length           |                      | samtools stats: LRL     | N  |  Y  |  Y  |
| read 2 deletion by cycle        |                      | CIGAR                   | Y  |  N  |  Y  |
| read 2 hard clip by cycle       |                      | CIGAR                   | Y  |  N  |  Y  |
| read 2 insertion by cycle       |                      | CIGAR                   | Y  |  N  |  Y  |
| read 2 length histogram         |                      | samtools stats: LRL     | N  |  Y  |  Y  |
| read 2 mismatch by cycle        |                      | samtools stats: MPC     | N  |  Y  |  -  |
| read 2 quality by cycle         |                      | samtools stats: LFQ     | N  |  Y  |  Y  |
| read 2 quality histogram        |                      | samtools stats: LFQ     | N  |  Y  |  Y  |
| read 2 soft clip by cycle       |                      | CIGAR                   | Y  |  N  |  Y  |
| read ? aligned by cycle         |                      | CIGAR                   | Y  |  N  |  Y  |
| read ? average length           |                      | CIGAR                   | Y  |  N  |  Y  |
| read ? deletion by cycle        |                      | CIGAR                   | Y  |  N  |  Y  |
| read ? hard clip by cycle       |                      | CIGAR                   | Y  |  N  |  Y  |
| read ? insertion by cycle       |                      | CIGAR                   | Y  |  N  |  Y  |
| read ? length histogram         |                      | CIGAR                   | Y  |  N  |  Y  |
| read ? mismatch by cycle        |                      | samtools stats: MPC     | N  |  Y  |  -  |
| read ? quality by cycle         |                      | CIGAR                   | Y  |  N  |  Y  |
| read ? quality histogram        |                      | CIGAR                   | Y  |  N  |  Y  |
| read ? soft clip by cycle       |                      | CIGAR                   | Y  |  N  |  Y  |
| reads mapped and paired         | mate unmapped reads  | samtools stats: SN      | N  |  Y  |  Y  |
| reads on target                 |                      | bedtools                | Y  |  N  |  Y  |
| RPSP (DEPRECATED)               |                      | RNAME/POS fields        | Y  |  N  |  N  |
| readsMissingMDtags              |                      | CIGAR                   | Y  |  N  |  Y  |
| run name                        |                      | metadata                | N  |  N  |  Y  |
| sample                          |                      | metadata                | N  |  N  |  Y  |
| sample level                    |                      | input parameter         | N  |  N  |  N  |
| sample total                    |                      | samtools view -s        | N  |  N  |  N  |
| soft clip bases                 |                      | CIGAR                   | Y  |  N  |  Y  |
| target file                     |                      | input parameter         | N  |  N  |  Y  |
| target sizes                    |                      | bedtools                | Y  |  N  |  Y  |
| tissue origin                   |                      | metadata                | N  |  N  |  Y  |
| tissue type                     |                      | metadata                | N  |  N  |  Y  |
| total bases on target           |                      | bedtools                | Y  |  N  |  Y  |
| total input reads meta          |                      | metadata                | N  |  N  |  N  |
| total reads                     |                      | samtools stats: SN      | N  |  Y  |  Y  |
| total target size               | target size          | bedtools                | N  |  N  |  Y  |
| unmapped reads                  |                      | samtools stats: SN      | N  |  Y  |  Y  |
| unmapped reads meta             |                      | metadata                | N  |  N  |  N  |
| workflow version                |                      | input parameter         | N  |  N  |  Y  |
